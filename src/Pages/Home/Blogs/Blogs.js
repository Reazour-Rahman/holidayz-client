        ...
        <aside className="col-small">
          ...
          {user.email ? (
            ...
            <div class="alert alert-success" role="alert">
              ...
              <p>
                To share your travel experience you have
                to signup or signin first. You will get access
                to see details of users blogs and get access to 
                post your experience!
              </p>

              <p class="mb-0">
                Whenever you logged in , scroll down and come here.
                You will get access to post.
              </p>
            </div>
          )}
        </aside>
